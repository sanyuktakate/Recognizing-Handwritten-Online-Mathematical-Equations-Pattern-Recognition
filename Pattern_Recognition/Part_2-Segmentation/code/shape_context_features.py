...
def stroke_pair_shape_context(stroke1_x_list, stroke1_y_list, stroke2_x_list, stroke2_y_list):
    ...
    # this is the radius of the circle, that is the distance from the
    ...
    pts_in_circle = pts_lying_in_circle(Radius,stroke1_bb_centers, stroke1_x_list, stroke1_y_list, stroke2_x_list, stroke2_y_list)
...
def pts_lying_in_circle(radius, bb_center, stroke1_x_list, stroke1_y_list, stroke2_x_list, stroke2_y_list):
...
def rd_stpair_shape_feature(bb_centers, stroke1_x_list, stroke1_y_list, stroke2_x_list, stroke2_y_list):
    ...
    for i in range(len(stroke1_x_list)):  # lop through stroke1
        # euclidean distance
        distance = math.hypot(stroke1_bb_x - stroke1_x_list[i], stroke1_bb_y - stroke1_y_list[i])
